...
if (!file.exists("internal/xgboost4j-spark/xgboost4j-spark-0.80.jar")) download.file(
  "http://central.maven.org/maven2/ml/dmlc/xgboost4j-spark/0.80/xgboost4j-spark-0.80.jar",
  "internal/xgboost4j-spark/xgboost4j-spark-0.80.jar"
)
